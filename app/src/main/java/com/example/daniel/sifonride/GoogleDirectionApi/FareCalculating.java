...
public class FareCalculating {
    ...
    public FareCalculating(DirectionFinderListener listener, LatLng origin, LatLng destination) {
    ...
    public void execute() throws UnsupportedEncodingException {
        ...
        new FareCalculating.DownloadRawData().execute(createUrl());
    }
